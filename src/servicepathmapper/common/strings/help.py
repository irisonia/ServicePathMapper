...
OUTPUT_STATS_HELP_STR = (
    ...
    f'\n`{output_stats.OUTPUT_STATS_DEAD_END_SERVERS}`:'
    f'\n{output_stats.OUTPUT_STATS_DEAD_END_SERVERS_HELP_STR}'
    f'\n`{output_stats.OUTPUT_STATS_UNREACHABLE_SERVERS}`:'
    f'\n{output_stats.OUTPUT_STATS_UNREACHABLE_SERVERS_HELP_STR}'
