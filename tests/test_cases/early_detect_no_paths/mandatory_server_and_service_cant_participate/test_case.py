...
def test_log_mandatory_server_cant_participate(caplog) -> None:
    run_test_case_with_log_message(
        config=_get_config(),
        expected_values={'servers': '"d"', 'services': '"1111"'},
        expected_help_topics=[program_args.ARG_MANDATORY_SERVERS, program_args.ARG_MANDATORY_SERVICES],
