...
def test_server_not_participating_doe_to_max_path_len() -> None:
...
_expected_participation_in_paths_ctrs = {
    ...
    output_stats.OUTPUT_STATS_ACTUAL_NON_PARTICIPATING_SERVICES: ["10", "12", "2", "3", "4"],
    output_stats.OUTPUT_STATS_ACTUAL_SERVICE_PARTICIPATION_CTR: [
        {output_stats.OUTPUT_STATS_SERVICE: "1", output_stats.OUTPUT_STATS_PARTICIPATION_COUNTER_PATHS: 2},
