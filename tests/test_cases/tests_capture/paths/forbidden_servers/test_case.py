...
_expected_config_stats = {
    ...
    output_stats.OUTPUT_STATS_SERVICES_UNREACHABLE_FOR_SOLE_PROVIDER_CLIENT: [
        {output_stats.OUTPUT_STATS_SERVER: "z", output_stats.OUTPUT_STATS_SERVICES: ["7", "9"]},
        {output_stats.OUTPUT_STATS_SERVER: "e", output_stats.OUTPUT_STATS_SERVICES: ["11"]}
    ]
}

_expected_participation_in_paths_ctrs = {
    output_stats.OUTPUT_STATS_ACTUAL_NON_PARTICIPATING_SERVERS: ["z", "e"],
    output_stats.OUTPUT_STATS_ACTUAL_SERVER_PARTICIPATION_CTR: [
        {
            output_stats.OUTPUT_STATS_SERVER: "a",
            output_stats.OUTPUT_STATS_PARTICIPATION_COUNTER_GROUPS: 3,
            output_stats.OUTPUT_STATS_PARTICIPATION_COUNTER_PATHS: 4
        },
        {
    ...
    output_stats.OUTPUT_STATS_ACTUAL_NON_PARTICIPATING_SERVICES: ["10", "2", "3", "4"],
    output_stats.OUTPUT_STATS_ACTUAL_SERVICE_PARTICIPATION_CTR: [
        {output_stats.OUTPUT_STATS_SERVICE: "1", output_stats.OUTPUT_STATS_PARTICIPATION_COUNTER_PATHS: 4},
        {output_stats.OUTPUT_STATS_SERVICE: "5", output_stats.OUTPUT_STATS_PARTICIPATION_COUNTER_PATHS: 4},
