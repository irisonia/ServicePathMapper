...
def test_server_not_participating_as_all_providers_are_not_in_allowed() -> None:
...
_expected_config_stats = {
    output_stats.OUTPUT_STATS_SERVICES_HAVING_CLIENTS_BUT_NO_PROVIDERS: [
        ...
        {
            output_stats.OUTPUT_STATS_SERVICE: "111",
        ...
        {
            output_stats.OUTPUT_STATS_SERVICE: "222",
            output_stats.OUTPUT_STATS_CLIENTS_COUNTER: 1,
            output_stats.OUTPUT_STATS_CLIENTS:
                [
                    "m"
...
_expected_participation_in_paths_ctrs = {
    output_stats.OUTPUT_STATS_ACTUAL_NON_PARTICIPATING_SERVERS: ["e", "m", "n"],
    ...
    output_stats.OUTPUT_STATS_ACTUAL_NON_PARTICIPATING_SERVICES: ["3", "4", "8888", "9999"],
